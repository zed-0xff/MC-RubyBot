...
#  { command: "messages", stringArg: "" },
#  { command: "sounds" }
#  { command: "addParticle", target: { x: -39, y: 2.2, z: 21 }}
#  { command: "Screen.lockSlot", intArg: 23, intArg2: -1, boolArg: true }
#  { command: "blocks", stringArg: "looking_at", expand: { x: 1, y: 0, z: 1} }
